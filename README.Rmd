...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.2888340.svg)](https://doi.org/10.5281/zenodo.2888340) ![GitHub tag (latest SemVer)](https://img.shields.io/github/tag/abfleishman/trakR.svg?color=blue&label=Version)

Cite as: 
Fleishman, A.B., Orben, R.A., and Gilmour, M. E. 2019. trakR: Basic Animal Tracking Data Analysis Tools. Version 0.0.9. GitHub repository. <https://github.com/abfleishman/trakR> DOI:10.5281/zenodo.2888340
